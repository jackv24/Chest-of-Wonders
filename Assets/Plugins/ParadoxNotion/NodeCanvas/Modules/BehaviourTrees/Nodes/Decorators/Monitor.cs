...
namespace NodeCanvas.BehaviourTrees{
	...
	[Category("Decorators")]
	[Icon("Eye")]
	[Description("Monitors the child node for a final Status return and executes an Action if the returned Status is the same as the Monitor Status selected.\nThe final Status returned to the parent can either be the original Decorated Child Node Status, or the new Decorator Action Status.")]
