...
public class PlayerActions : PlayerActionSet
{
    ...
    public PlayerActions()
    {
        ...
        Attack1.AddDefaultBinding(InputControlType.RightBumper);

        Attack2.AddDefaultBinding(Mouse.RightButton);
        Attack2.AddDefaultBinding(InputControlType.RightTrigger);
        ...
        Submit.AddDefaultBinding(InputControlType.Action3);
    }
}
